...
To build OASIS Core using AFL instrumentation (this assumes that the
...
with certain assembly code from OASIS Core's code. See [developer notes on sanitizers](https://github.com/OasisCoinTeam/oasis/blob/master/doc/developer-notes.md#sanitizers)
