...
class DIP3Test(PivxTestFramework):
    ...
    def run_test(self):
        ...
        # Note: dmn2 sends (2 * 0.3 XOS) to the operator, and (2 * 2.7 XOS) to the owner
        ...
        assert_raises_rpc_error(-5, "invalid OASIS address InvalidPayee",
        ...
        assert_raises_rpc_error(-5, "invalid OASIS address InvalidPayee", controller.protx_update_registrar,
