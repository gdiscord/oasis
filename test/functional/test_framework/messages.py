...
COIN = 100000000 # 1 XOS in satoshis
...
# Objects that map to oasisd objects, which can be serialized/deserialized
...
class msg_headers:
    ...
    def deserialize(self, f):
        # comment in oasisd indicates these should be deserialized as blocks
