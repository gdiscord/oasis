...
class FullBlockTest(PivxTestFramework):
    ...
    def run_test(self):
        ...
        # Extend the b26 chain to make sure oasisd isn't accepting b26
        ...
        # Extend the b28 chain to make sure oasisd isn't accepting b28
        ...
        # OASIS: timestamp checks disabled for regtest
        ...
        #    Low-S and High-S values (whereas the oasis code has custom code which does so);
