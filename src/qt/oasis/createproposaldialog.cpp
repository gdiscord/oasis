...
#include "qt/oasis/createproposaldialog.h"
#include "qt/oasis/forms/ui_createproposaldialog.h"
...
CreateProposalDialog::CreateProposalDialog(OASISGUI* parent, GovernanceModel* _govModel, WalletModel* _walletModel) :
    QDialog(parent),
...
void CreateProposalDialog::setupPageOne()
{
    ...
    setEditBoxStyle(ui->labelURL, ui->lineEditURL, "e.g https://forum.oasis/proposals/best_proposal_ever");
...
void CreateProposalDialog::setupPageTwo()
{
    ...
    setEditBoxStyle(ui->labelAmount, ui->lineEditAmount, "e.g 500 XOS");
