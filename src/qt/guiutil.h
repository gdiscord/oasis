...
// Format an amount
QString formatBalance(CAmount amount, int nDisplayUnit = 0, bool isZxos = false);
QString formatBalanceWithoutHtml(CAmount amount, int nDisplayUnit = 0, bool isZxos = false);
