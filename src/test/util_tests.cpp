...
BOOST_AUTO_TEST_CASE(test_Capitalize)
{
    ...
    BOOST_CHECK_EQUAL(Capitalize("oasis"), "Pivx");
...
BOOST_AUTO_TEST_CASE(test_validateURL)
{
    ...
    BOOST_CHECK(validateURL("https://foo.bar/"));
    BOOST_CHECK(validateURL("http://oasis.foo.bar"));
    BOOST_CHECK(validateURL("https://foo.bar/oasis"));
    BOOST_CHECK(validateURL("https://foo.bar/oasis/more/"));
    BOOST_CHECK(validateURL("https://142.2.3.1"));
    BOOST_CHECK(validateURL("https://foo_bar.oasis.com"));
