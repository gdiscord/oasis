...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help")) {
        ...
        std::string strUsage = PACKAGE_NAME " oasis-tx utility version " + FormatFullVersionWithCodename() + "\n\n" +
                               "Usage:  oasis-tx [options] <hex-tx> [commands]  Update hex-encoded oasis transaction\n" +
                               "or:     oasis-tx [options] -create [commands]   Create hex-encoded oasis transaction\n" +
                               "\n";
