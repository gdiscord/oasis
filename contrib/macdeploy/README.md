...
When complete, it will have produced `OASIS-Core.dmg`.
...
the file-order will change between invocations. The patch can be seen here: [cdrkit-deterministic.patch](https://github.com/OasisCoinTeam/oasis/blob/master/depends/patches/native_cdrkit/cdrkit-deterministic.patch).
...
- The Apple keyholder uses this unsigned app to create a detached signature, using the
  script that is also included there. Detached signatures are available from this [repository](https://github.com/OasisCoinTeam/oasis-detached-sigs).
